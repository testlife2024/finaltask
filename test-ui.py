...
def test_search_product_neg():
    ...
    driver.find_element(By.CSS_SELECTOR, '#applySearchBtn').click()
    WebDriverWait(driver,5).until(EC.text_to_be_present_in_element((By.CSS_SELECTOR, '#app > div:nth-child(5) > div.catalog-page.catalog-page--non-search > div > div.catalog-page__not-found.not-found-search > div > h1'), result_txt))
    assert driver.find_element(By.CSS_SELECTOR,'#app > div:nth-child(5) > div.catalog-page.catalog-page--non-search > div > div.catalog-page__not-found.not-found-search > div > h1').text == result_txt
    driver.quit()
...
def test_directions():
    ...
    WebDriverWait(driver,10).until(EC.visibility_of_element_located((By.CSS_SELECTOR,'#__next > main > div:nth-child(1) > div > div > div > div.LjquDB-1751270365211 > div.t_w8QQ-1751270365211 > div.shared__tag-button-module__tagButtonGroup--9aBd8_1748530590763 > div.shared__tag-button-module__button--Qv07L_1748530590763.shared__tag-button-module__button__tab--rVLma_1748530590763.shared__tag-button-module__selected--hP5R8_1748530590763.undefined > span')))
    element = driver.find_element(By.CSS_SELECTOR,'#__next > main > div:nth-child(1) > div > div > div > div.LjquDB-1751270365211 > div.t_w8QQ-1751270365211 > div.shared__tag-button-module__tagButtonGroup--9aBd8_1748530590763 > div.shared__tag-button-module__button--Qv07L_1748530590763.shared__tag-button-module__button__tab--rVLma_1748530590763.shared__tag-button-module__selected--hP5R8_1748530590763.undefined > span')
...
def test_content_page():
    ...
    WB.WB(driver).wibes()
    requests = 'еда'
    driver.find_element(By.CSS_SELECTOR,'body > div.layout > aside > section > nav > ul > li:nth-child(2) > button').click()
    driver.find_element(By.XPATH,'//*[@id="radix-:Rifekva:"]/div/div[1]/div[2]/div/input').send_keys(requests)
